...
//IAnimal not loaded via codebase property
...
//    }
    ...
    public String getSpecyName() throws RemoteException {
        return this.seulPatient.getSpecy().getName();
    }

    @Override
    public Double getAverageLifeSpanInDays(String specyName) throws RemoteException {
        return this.seulPatient.getSpecy().getAverageLifeSpanInDays();
    }
    ...
    public String getFollowUpFileContent() throws RemoteException {
        return this.seulPatient.getFollowUpFile().getContent();
    }
