 ...
 *         &lt;element name="chosenRooms" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class MakeBooking {
    ...
    protected List<String> chosenRooms;
    ...
    /**
     * Gets the value of the chosenRooms property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the chosenRooms property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChosenRooms().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<String> getChosenRooms() {
        if (chosenRooms == null) {
            chosenRooms = new ArrayList<String>();
        }
