...
//    private List<Room> rooms;  // Refactoring here from soap
    ...
    public Booking(String bookingReference, String clientBookingLastName, String clientBookingFirstName, Date arrivalDate, Date checkoutDate, int numberPersons) {
